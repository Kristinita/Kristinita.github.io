...
<body>
    ...
    <section class="container">
        ...
        <map id="map" name="map">
            <area shape="rect" title="Rectangle" coords="360,30,442,208" class="tooltip hover" />
            <area shape="circle" title="Circle" coords="98,113,66" class="tooltip hover" />
            <area shape="poly" title="Polygon" coords="228,52,331,236,193,166" class="tooltip hover" />
        </map>
    </section>

    <section id="inline_container" class="container">
        <p>Lorem ipsum dolor sit amet, <strong class="tooltip hover inline" title="First">consectetur adipisicing elit</strong>. Magni omnis, molestias natus sit odio aliquid expedita quibusdam asperiores ducimus eos, tenetur quasi dolores quae iste quaerat,
            maxime consectetur ab repellendus.</p>
