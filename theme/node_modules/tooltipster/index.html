...
<body>
    ...
    <div id="wrapper">
        ...
        <section id="welcome">
            ...
            <h1>
                A flexible and extensible jQuery plugin for modern tooltips.<br /> Simple enough for everyone, powerful enough for everything.
            </h1>
        ...
        <div id="templates">
            <div id="demo-html-content">
                ...
                <p style="text-align:left;">
                    <strong>Lorem ipsum dolor sit amet</strong><br /> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu.
                </p>
            </div>
...
&lt;/head&#62;
            ...
            <p>Bonus: Also available on <a href="https://www.npmjs.com/package/tooltipster" target="_blank">Npm</a>, <a href="https://libraries.io/bower/tooltipster" target="_blank">Bower</a> and <a href="https://www.jsdelivr.com/projects/jquery.tooltipster" target="_blank">jsDelivr</a>.<br /> Bonus 2: if you need .gz files, running <span class="code">grunt compress</span> will gzip all files within the dist folder.</p>
...
$('.tooltip').tooltipster({
    contentCloning: true
            ...
            <p>
                Tooltipster's features may be extended through the use of plugins. They may add new styles, new options, new methods, new behaviors, etc.<br /> Some popular plugins for Tooltipster are:
            </p>
    ...
    ...
        ...
        <section id="methods">
            ...
            <table class="table_methods" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <h4>on, one, off, triggerHandler</h4>
                    </td>
                    <td>callback</td>
...
$('#my-tooltip').tooltipster({
    functionPosition: function(instance, helper, position){
        ...
        return position;
            ...
            <h3 id="htmlcontentalt">Alternative ways of setting HTML content <a href="#usecases">&#8657;</a></h3>
            </h3>
...
$("#my-tooltip").tooltipster({
    functionInit: doThat
            ...
            <p>
                The <span class="code">init</span>, <span class="code">before</span>, <span class="code">ready</span>, <span class="code">after</span>, <span class="code">format</span> and <span class="code">position</span> events will sound familiar: they happen at the same time as their equivalent <span class="code">functionInit</span>, etc.<br /> But there are many others that you or plugin makers can use. Your listeners will get one argument, the event, which holds useful properties: <span class="code">event.type</span>, <span class="code">event.instance</span>, <span class="code">event.origin</span>, <span class="code">event.event</span> (when there is one, similarly to the usual <span class="code">helper.event</span>) and potentially others as described below. These are all the possible events:
            </p>
            ...
            <p>By default, <span class="code">sideTip</span> is the only plugin used by Tooltipster. <span class="code">sideTip</span> takes care of positioning tooltips on a side of their origin.<br /> In fact, the name of our main file is <span class="code">tooltipster.bundle.js</span> because it is a bundle of <span class="code">tooltipster.core</span> and <span class="code">tooltipster-sideTip</span>.</p>
...
&lt;/head&#62;
            ...
            <p>Accessible tooltips can be powered by Tooltipster. To do this, one solution is to actually manipulate in parallel two tooltips which will share the same content :<br /> - the ARIA tooltip, which is invisible on the screen but readable by ARIA-compatible software<br /> - the Tooltipster tooltip, which is visible on the screen but does not appear as an ARIA-compatible element
            </p>
...
$('#myfield')
    ...
    .blur(function(){
        ...
        <section id="faq">
            ...
            <p>These elements do not trigger events anymore when they are disabled, which will cause Tooltipster to malfunction. There is no way around it, so we suggest you make them "look" disabled with CSS and Javascript, but do not set the actual `disabled` property on them.</p>
