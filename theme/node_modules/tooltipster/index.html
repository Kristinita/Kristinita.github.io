    ...
    <div id="wrapper">
        ...
        <section id="demos">
            ...
            <ul>
                ...
                <li>
                    <span id="demo-position" data-tooltip-content="#demo-position-content">Hover</span>
                    <div id="demo-position-grid">Custom position</div>
                </li>
                <li>
        ...
        <section id="getting-started">
            ...
            <p>After you <a href="https://github.com/iamceege/tooltipster/archive/master.zip">download Tooltipster</a>, load jQuery and include Tooltipster's CSS and JavaScript files in your page.
                <br />
            </p>
...
&lt;/head&#62;
            ...
            <p>Bonus: Also available on <a href="https://www.npmjs.com/package/tooltipster" target="_blank">Npm</a>, <a href="https://libraries.io/bower/tooltipster" target="_blank">Bower</a> and <a href="https://www.jsdelivr.com/projects/jquery.tooltipster"
                target="_blank">jsDelivr</a>.
                <br /> Bonus 2: if you need .gz files, running <span class="code">grunt compress</span> will gzip all files within the dist folder.</p>

            <h3>2. Set up your HTML</h3>

            <p>To spot the elements which will get a tooltip, aka the "origins", we will give them a <span class="code">'tooltip'</span> class. You may use another class name or even other means of selection, your choice. After that, we will set the
                <span
                class="code">title</span> attribute to whatever we'd like our tooltip to say. Here are a couple examples:</p>
...
&lt;span class="tooltip" title="This is my span's tooltip message!"&gt;Some text&lt;/span&gt;
            ...
            <p>The last thing we have to do is activate Tooltipster. To do this, add the following script right before your closing <span class="code">&lt;/head&#62;</span> tag (using whatever selector you like - in this case we're still using the
                <span
                class="code">'tooltip'</span> class):</p>
...
&lt;/div&#62;</pre>
            ...
            <p>Important: if you have two tooltips that have the same <span class="code">data-tooltip-content</span> attribute (that is to say, want to both use the same HTML element), please set the <span class="code">contentCloning</span> option to
                <span
                class="code">true</span> when you initialize your tooltips:</p>
...
$('.tooltip').tooltipster({
    contentCloning: true
            ...
            <p>
                ...
                <br /> Some popular plugins for Tooltipster are:
            </p>
   ...
   trigger: 'click'
            ...
            <table id="table_options" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>Determines how the tooltip will animate in and out. In addition to the built-in transitions, you may also create custom transitions in your CSS files. In IE9 and lower, all animations default to a JavaScript generated, fade animation.
                        <strong>Default: 'fade'</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>animationDuration</h4></td>
                    <td>integer,
                        <br />integer[]</td>
                ...
                <tr>
                    ...
                    <td>integer,
                        <br />integer[]</td>
                    <td>Upon mouse interaction, this is the delay before the tooltip starts its opening and closing animations when the 'hover' trigger is used <span class="tooltip" title="More specifically: when the 'triggerOpen.mouseenter' and/or 'triggerClose.mouseleave' are used">(<span class="red">*</span>)</span>.
                        If you wish to specify different delays for opening and closing, you may provide an array of two different values. <strong>Default: 300</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>delayTouch</h4></td>
                    <td>integer,
                        <br />integer[]</td>
                    <td>Upon touch interaction, this is the delay before the tooltip starts its opening and closing animations when the 'hover' trigger is used <span class="tooltip" title="More specifically: when the 'triggerOpen.touchstart' and/or 'triggerClose.touchleave' are used">(<span class="red">*</span>)</span>.
                        If you wish to specify different delays for opening and closing, you may provide an array of two different values. <strong>Default: [300, 500]</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>distance</h4></td>
                ...
                <tr>
                    <td>
                        <h4>functionFormat</h4></td>
                    <td>function</td>
                    <td>A custom function that does not modify the content but that can format it for display. It gets the two first usual <a href="#callback_arguments">arguments</a> and also the content as third argument. It must return the value that will
                        be displayed in the tooltip, either a string or a jQuery-wrapped HTML element (see the <a href="#formatting">formatting section</a>). <strong>Default: none (null)</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>functionPosition</h4></td>
                    <td>function</td>
                    <td>A custom function fired when the tooltip is repositioned. It gives you the ability to slightly or completely modify the position that Tooltipster is about to give to the tooltip. It gets the proposed set of placement values as third
                        argument. The function must return the set of placement values, which you may have edited (see the <a href="#positioning">positioning section</a>). <strong>Default: none (null)</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>IEmin</h4></td>
                ...
                <tr>
                    <td>
                        <h4>interactive</h4></td>
                    <td>boolean</td>
                    <td>Give users the possibility to interact with the content of the tooltip. If you want them to be able to make clicks, fill forms or do other interactions inside the tooltip, you have to set this option to true. When the 'hover' close
                        trigger is used, the user has to move the cursor to the tooltip before it starts closing (this lapse of time has its duration set by the 'delay' option). <strong>Default: false</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>maxWidth</h4></td>
                ...
                <tr>
                    <td>
                        <h4>restoration</h4></td>
                    <td>'none',
                        <br />'previous',
                        <br />'current'</td>
                    <td>Specifies if a TITLE attribute should be restored on the HTML element after a call to the 'destroy' method. This attribute may be omitted, or be restored with the value that existed before Tooltipster was initialized, or be restored
                        with the stringified value of the current content. Note: in case of multiple tooltips on a single element, only the last destroyed tooltip may trigger a restoration. <strong>Default: 'none'</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>selfDestruction</h4></td>
                    <td>boolean</td>
                ...
                <tr>
                    ...
                    <td>string,
                        <br />string[]</td>
                    <td>Sets the side of the tooltip. The value may one of the following: 'top', 'bottom', 'left', 'right'. It may also be an array containing one or more of these values. When using an array, the order of values is taken into account as order
                        of fallbacks and the absence of a side disables it (see the <a href="#sides">sides section</a>). <strong>Default: ['top', 'bottom', 'right', 'left']</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>timer</h4></td>
                ...
                <tr>
                    <td>
                        <h4>trackerInterval</h4></td>
                    <td>integer</td>
                    <td>Sets how often the tracker should run (see trackOrigin and trackTooltip), in milliseconds. The tracker runs even if trackOrigin and trackTooltip are false to check if the origin has not been removed while the tooltip was open, so you
                        shouldn't set too high or too low values unless you need to. <strong>Default: 500</strong></td>
                </tr>
                <tr>
                    <td>
                        <h4>trackOrigin</h4></td>
                    <td>boolean</td>
                ...
                <tr>
                    <td>
                        <h4>triggerClose</h4></td>
                    <td>object</td>
                    <td>When 'trigger' is set to 'custom', all built-in close triggers are disabled by default. This option allows you to reactivate the triggers of your choice to create a customized behavior. Only applies if 'trigger' is set to 'custom'.
                        See the <a href="#triggers">triggers section</a>.</td>
                </tr>
                <tr>
                    <td>
                        <h4>triggerOpen</h4></td>
                    <td>object</td>
                    <td>Similar to 'triggerClose'.</td>
                </tr>
                <tr>
                    <td>
                        <h4>updateAnimation</h4></td>
                    <td>'fade',
                        <br />'rotate',
                        <br />'scale',
                        <br />null</td>
            ...
            <p>Almost all user callbacks have the same input signature. It means that <span class="code">functionInit</span>, <span class="code">functionBefore</span>, <span class="code">functionReady</span>, <span class="code">functionAfter</span>,
                <span
                class="code">functionFormat</span>, <span class="code">functionPosition</span> and the <span class="code">open</span> and <span class="code">close</span> callbacks all get these two parameters:</p>
...
functionInit(instance, helper){
    ...
            ...
            <p><span class="code">helper.event</span> is present in <span class="code">functionBefore</span> and <span class="code">functionAfter</span> callbacks. It's the mouse or touch event that triggered the opening or the closing of the tooltip. When
                the action was not triggered by a mouse or touch event, this variable is <span class="code">null</span> or <span class="code">undefined</span>.</p>
        ...
        <section id="methods">
            ...
            <p>For advanced use cases, Tooltipster offers a set of methods to manipulate your tooltips. They allow you to create custom triggers, update tooltip content on the fly (whether the tooltip is currently open or not), destroy Tooltipster functionality
                if needed, reposition tooltips and more.</p>
            ...
            <p>The latter will be discussed in the <a href="#object-oriented">object-oriented section</a>. Users with simple use cases just need to know that it's the recommended way of calling methods when you are inside <span class="code">functionInit</span>,
                <span class="code">functionBefore</span> and the like. Here is the list of instance methods:</p>
            <br />
            <br />
            ...
            <table class="table_methods" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <h4>on, one, off, triggerHandler</h4></td>
                    <td>callback</td>
                ...
                <tr>
                    <td>
                        <h4>option (getter)</h4></td>
                    <td>optionName</td>
                    <td>Returns the value of an option.</td>
                </tr>
                <tr>
                    <td>
                        <h4>option (setter)</h4></td>
...
.tooltipster-sidetip.tooltipster-noir.tooltipster-noir-customized .tooltipster-content {
	...
	padding: 8px;
            ...
            <p>For your secondary theme to be applied, provide an array of themes instead of just one. You may even provide more than two themes if you create a secondary theme to your secondary theme! In other words, this allows sub-themes, sub-sub-themes,
                etc. for your tooltips.</p>
...
instance.content('My new content');
            ...
            <p>Tooltipster gives you the ability to fire a custom function when a tooltip is initialized (<span class="code">functionInit</span>), but also every time the tooltip is about to open (<span class="code">functionBefore</span>), when it has opened
                (<span class="code">functionReady</span>) or after it has closed (<span class="code">functionAfter</span>).</p>

            <p>One great use for this is to grab dynamic content for your tooltips via AJAX. In this example we will use <span class="code">functionBefore</span> to load data the first time the tooltip is opened. Until the data has been loaded, we will display
                a "Loading..." notification:</p>
...
$('.tooltip').tooltipster({
    ...
    functionBefore: function(instance, helper) {
        ...
        if ($origin.data('loaded') !== true) {
            ...
            <p>In addition to this, you may provide a function as the callback argument of the open/close methods. If the tooltip is already in the state you are asking for (open & stable/closed), the callback is executed immediately. Please note that if
                the open/close action is somehow cancelled before it has completed its animation, the callback function will never be called.</p>
            <pre class="prettyprint">
$(document).ready(function() {
    ...
    $(window).keypress(function() {
        $('#example').tooltipster('close', function(instance, helper) {
            ...
            <p>Let's hover a little on how the <span class="code">side</span> option works.
                <br />You have two options: provide either a string, like <span class="code">side: 'top'</span>, or an array of strings, like <span class="code">side: ['top', 'bottom']</span> for example.</p>

            <h4>What happens when I provide a string, like <span class="code">'top'</span> ?</h4>

            <p>This tells Tooltipster that you'd prefer the tooltip to be above the tooltipped element, but allows the tooltip to be positioned differently if need be.
                <br />This means that if there is not enough space on top for your tooltip, the other sides may be used a fallbacks. Here is the order of fallbacks, depending on what side you chose:</p>
...
'left'	   =>	['left', 'right', 'top', 'bottom']</pre>
            ...
            <p>Secondly if you want to disable totally one or more sides. For example, with <span class="code">['top', 'right', 'left']</span>, the tooltip will never be positioned on the bottom. With <span class="code">['right']</span>, the tooltip will
                always be on the right, even if it has to overflow the document.</p>
...
$('#example').tooltipster({
    ...
    triggerClose: {
        ...
        tap: true
            ...
            <p>To achieve this, Tooltipster has the <span class="code">open</span> and <span class="code">close</span> methods. Both of them may receive an optional callback argument, which represents a function you'd like to be called when the tooltip is
                done animating.</p>
...
$(document).ready(function() {
   ...
   $(window).keypress(function() {
      $('#example').tooltipster('close');
            ...
            <p>When you provide custom coordinates for the tooltip and its arrow, they have to be relative to the top and left edges of the viewport. This makes custom positioning in Tooltipster both very fast and very simple. Doing your calculations,
                <a
                href="https://developer.mozilla.org/fr/docs/Web/API/Element/getBoundingClientRect" target="_blank"><span class="code">element.getBoundingClientRect</span></a> will become your new best friend, so make sure you check it out.</p>

            <p>Your <span class="code">functionPosition</span> callback is called with three parameters. The first two ones are <span class="code">instance</span> and a <span class="code">helper</span>, <a href="#callback_arguments">as usual</a>. The third
                argument is an object with the position properties proposed by Tooltipster, that you may edit. <b>You must return</b> the edited third argument for the changes to get applied.</p>
            ...
            <p><span class="code">helper.whole</span> (boolean) indicates if the tooltip is fully on screen.</p>
            ...
            <pre class="prettyprint">
{
    ...
    target: number
            ...
            <p><span class="code">target</span> represents the location Tooltipster thinks the tooltip should ideally be centered on, and the arrow aiming at. It is given as the distance from the relevant edge of the viewport (left edge if the side is "top"
                or "bottom", top edge if the side is "left" or "right"). The target is usually the middle of the origin, but can be somewhere else when the origin is actually a portion of text split in several lines. Editing this value will change the
                location the arrow is aiming at but will not change the position of the tooltip itself (use <span class="code">coord</span> for that).</p>
...
console.log($('#example').tooltipster('content'));
            ...
            <p>Simple, right? It works, however this is not ideal for us if we need to get ahold of our data set later. Because as you can see, when we call the <span class="code">content</span> method, we get the computed sentence, not our initial data
                set. No worries, the <span class="code">functionFormat</span> option is here to help us.</p>
            ...
            <pre class="prettyprint">
{
    ...
    state: 'appearing' || 'stable' || 'disappearing' || 'closed'
            ...
            <p>So far, quite often we called instance methods like this: <span class="code">$(...).tooltipster(methodName)</span>. However, advanced users may prefer to handle objects directly rather that go through the DOM to manipulate their tooltips.
                That's possible with Tooltipster!</p>
...
instance.open().content('My new content');</pre>
            ...
            <p>What happened here? The <span class="code">instance</span> method returns the Tooltipster instance that corresponds to the <b>first</b> tooltip set on <span class="code">#my-element</span>. Once we have the Tooltipster instance that corresponds
                to a tooltip, we can call any methods directly on it to manipulate the tooltip.</p>

            <p>If <b>multiple</b> tooltips were set on <span class="code">#my-element</span> using the <span class="code">multiple</span> option (see next section), we'd have to call <span class="code">$.tooltipster.instances('#my-element');</span> to get
                an array with all the instances.</p>

            <p>As you've seen in many previous examples involving callbacks - either <span class="code">functionInit</span>, <span class="code">functionBefore</span>, etc., open/close callbacks, they all get the Tooltipster instance that calls them as first
                parameter. So this works fine:</p>
...
$('#origin').tooltipster({
    functionBefore: function(instance, helper){
        instance.content('Random content');
            ...
            <p>Several independent tooltips can be set on a single element, each one having its own triggers and options. Just set the <span class="code">multiple</span> option to <span class="code">true</span> when you initialize your tooltip. There is
                just something you need to be aware of when using multiple tooltips:</p>

            <p>Calling a method this way: <span class="code">$(...).tooltipster(methodName [, argument])</span> only ever calls the method on the <b>first</b> tooltip that was set on the element. That's an issue when you actually want to manipulate the second
                or third tooltip! Make sure you read the previous section as we have to manipulate Tooltipster instances instead to solve this.</p>
...
$('#my-element').tooltipster({
    ...
    multiple: true
            ...
            <p>We chose not to include that option directly because there is no solution that would be both 100% reliable and fast at the same time, and we wanted you to be aware of it before you proceeded. We recommend that you initialize tooltips manually
                after you create elements that should be tooltipped, in order to avoid any surprises. We do not provide support for issues that might arise from live binding.</p>

            <p>If you go the delegation way, you will rely on the bubbling of events (mouseenter or click) triggered on their origin. That may be an issue if these events are stopped from bubbling at some point, and you might run into race conditions depending
                on how you handle things. And of course, the tooltips won't be initialized until their origin is hovered/clicked, which may be an issue if you wish to manipulate them programmatically or if you use a plugin which is supposed to start working
                before the tooltip opens.</p>
...
$('body').on('mouseenter', '.tooltip:not(.tooltipstered)', function(){
    $(this)
        ...
        .tooltipster('open');
            ...
            <p>On the other hand, using mutation observers to initialize tooltips when elements are added to the DOM should completely reliable, but is known to severely hinder the performances of the application. Should you go down this road, feel free
                to share your code with us and we'll publish it here.</p>
...
instance
    ...
    .on('before', doThat);
            ...
            <p>Core listeners are great way to set default callbacks without writing something like <span class="code">$.tooltipster.setDefaults({ functionBefore: myFunction })</span>, which could potentially be overriden at initialization. For example,
                both <span class="code">doThis</span> and <span class="code">doThat</span> will be called here:</p>
...
$("#my-tooltip").tooltipster({
    functionInit: doThat
            ...
            <p> Remark: the events are sent to the core listeners first. Besides, the instance emitters and the core emitter are different objects, so unbinding a listener from the core emitter will not unbind it from instance emitters, if you ever bound
                it to both.</p>

            <h4 id="event-types">Event types</h4>

            <p>
                The <span class="code">init</span>, <span class="code">before</span>, <span class="code">ready</span>, <span class="code">after</span>, <span class="code">format</span> and <span class="code">position</span> events will sound familiar:
                they happen at the same time as their equivalent <span class="code">functionInit</span>, etc.
                <br /> But there are many others that you or plugin makers can use. Your listeners will get one argument, the event, which holds useful properties: <span class="code">event.type</span>, <span class="code">event.instance</span>, <span class="code">event.origin</span>,
                <span class="code">event.event</span> (when there is one, similarly to the usual <span class="code">helper.event</span>) and potentially others as described below. These are all the possible events:
            </p>
            ...
            <p><span class="code">close</span> happens at the start of the closing animation. Note: during the animation, the closing may be still cancelled if the tooltip is reopened. The event has a special <span class="code">event.stop</span> property
                which is a function you may call to ignore the closing order.</p>

            <p><span class="code">closing</span> happens at the end of the closing animation, when you know for sure that the tooltip is about to be closed. If you think you need this event, you may be wrong! When the tooltip is closed, remember that the
                content is just detached from the DOM and still accessible via the <span class="code">content</span> method.</p>
            ...
            <p><span class="code">format</span> has a special <span class="code">event.format</span> property which is a function you may use to format the content before display. Just provide your formatted content as first argument. For your convenience,
                the original content is provided in the <span class="code">event.content</span> property.</p>

            <p><span class="code">geometry</span> happens when Tooltipster determines the size and coordinates of the origin, in order to know where to place the tooltip. The computed properties (left, top, width and height) are passed in the <span class="code">event.geometry</span>                object. It has a special <span class="code">event.edit</span> property which is a function you may use to provide this information yourself. Just provide the edited geometry object as first argument. In some cases, this may be easier to
                use than <span class="code">functionPosition</span> as it allows you to provide a specific target without having to compute the final position yourself.</p>

            <p><span class="code">init</span> is triggered upon tooltip initialization and may thus be heard only by a core listener.</p>

            <p><span class="code">position</span> happens during the positioning process and can be used to provide a custom position (see <span class="code">functionPosition</span>). The proposed position is present in <span class="code">event.position</span>.
                The special <span class="code">event.edit</span> property is the function you may call with your edited positioning values as first argument.</p>

            <p><span class="code">positionTest</span> happens before <span class="code">position</span>, while sideTip is still evaluating the different positioning scenarios. While less straightforward to handle, it also brings the possibility to switch
                between scenarios more easily. As this gets more complex, please read the source code or ask for support about this.</p>
            ...
            <p><span class="code">state</span> happens every time the tooltip enters a different state. The state value is held in <span class="code">event.state</span> and may be <span class="code">'appearing'</span>, <span class="code">'stable'</span>,
                <span class="code">'disappearing'</span> or <span class="code">'closed'</span>.</p>
            ...
            <p>Tooltipster is composed of a core and one or several plugins.</p>

            <p>By default, <span class="code">sideTip</span> is the only plugin used by Tooltipster. <span class="code">sideTip</span> takes care of positioning tooltips on a side of their origin.
                <br /> In fact, the name of our main file is <span class="code">tooltipster.bundle.js</span> because it is a bundle of <span class="code">tooltipster.core</span> and <span class="code">tooltipster-sideTip</span>.</p>
...
$('#example').tooltipster({
    plugins: ['pluginNamespace.pluginName']
            ...
            <p>Under the hood, Tooltipster's plugin system is built on our event system. The plugins register to the core and when something happens, the core triggers an event that plugins may react to. A manual for plugin makers will be released soon.</p>
...
$('#example').tooltipster({
    functionBefore: function(instance, helper) {
        instance['laa.follower'].methodName();
            ...
            <p>The default <span class="code">sideTip</span> plugin adds a few options to Tooltipster. For the sake of simplicity, these options were listed previously among the core's options in the <a href="#options">Options</a> section. But if you decide
                not to use <span class="code">sideTip</span>, these options will actually not be available anymore, except if another plugin offers options of the same name. These specific options are:</p>

            <p><span class="code">arrow</span>, <span class="code">distance</span>, <span class="code">functionPosition</span>, <span class="code">minIntersection</span>, <span class="code">minWidth</span>, <span class="code">maxWidth</span>, <span class="code">side</span>,
                <span class="code">viewportAware</span></p>
...
$('#nesting').tooltipster({
    ...
    interactive: true
            ...
            <p>When the user hovers on adjacent elements one after the other to read their tooltips, you may wish to display the tooltips instantly rather than wait for the default delay and animation times. A demonstration is worth a thousand words, so
...
&lt;/head&#62;
            ...
            <p>Why? Because browsers do not always make our life easy when it comes to working with SVG. Determining the coordinates of SVG paths, polylines or polygons is especially difficult since the native <span class="code">getBoundingClientRect</span>,
                <span class="code">getBBox</span> and other methods produce inaccurate results in most browsers (as of today in 2016). The result is that by default, the position of tooltips on SVG elements may be completely off. Fortunately, SVG.js helps
                in that matter and our plugin leverages its power out of the box. Just include the files in your page and that's it, Tooltipster will use them out of the box for optimal results.</p>

            <p>For those who seek even more control over positioning, the <span class="code">position</span> event (or the corresponding <span class="code">functionPosition</span> option) and the <span class="code">geometry</span> event allow you to set
                the exact position of the tooltip yourself.</p>
            ...
            <p>Accessible tooltips can be powered by Tooltipster. To do this, one solution is to actually manipulate in parallel two tooltips which will share the same content :
                <br /> - the ARIA tooltip, which is invisible on the screen but readable by ARIA-compatible software
                <br /> - the Tooltipster tooltip, which is visible on the screen but does not appear as an ARIA-compatible element
            </p>
...
$('#myfield')
    ...
    .blur(function(){
        ...
        <section id="faq">
            ...
            <p>This typically happens when you put images inside the tooltip. The first time it opens, the image is not loaded yet and thus has no size, so Tooltipster basically computes a position as if there were no images. A few milliseconds later, when
                the image has loaded, the tooltip gets bigger but is not automatically repositioned. The second time the tooltip opens, the image is already in cache and is ready for display, so Tooltipster can compute an appropriate position.</p>
            ...
            <p>These elements do not trigger events anymore when they are disabled, which will cause Tooltipster to malfunction. There is no way around it, so we suggest you make them "look" disabled with CSS and Javascript, but do not set the actual `disabled`
                property on them.</p>
        ...
        <footer>
            Developed and maintained by <a href="https://plus.google.com/116532683962309427991?rel=author" class="white">Caleb Jacob</a> and <a href="https://github.com/louisameline" class="white">Louis Ameline</a> under the <a href="http://opensource.org/licenses/MIT"
            class="white">MIT license</a>
        </footer>
    </div>
